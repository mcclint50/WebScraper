...

{
	 ...
	 * 
	 * @param file is just a string containing the file
	 * 
	...
	public static boolean writePlayersToJSON(File file, ArrayList<Player> players)
	 ...
	 * @author Robert Oliver Jr
	 * 
	 * @param file   is a string containing our file
	 * 
	 * @param player is an array list that contains the players and their respective
	 *               data/ stats
	 * 
	 * @return a boolean stating true if there is data that needs to be written to
	 *         the text file
	 * 
	 */

	public static boolean writePlayersToTextFile(File file, ArrayList<Player> players)
	 ...
	 * 
	 * @param ArrayList<Player> p is an ArrayList filled with the players'
	 *                          data/stats
	 * 
