...
public class Player {
	...
	/**
	 * The following are all the get and set functions that can be used for this object
	 * @author Colin
	 */
	...
	/**
	 * This overrides the toString() function so every time a player is printed, it will print like this.
	 * @author Colin
	 */
